        ...
        <section class="mb-32">
          ...
          <div class="grid gap-6 lg:grid-cols-3">
            ...
            <div class="mb-6 md:mb-8 lg:mb-12">
              ...
              <p class="text-neutral-500 dark:text-neutral-300">
                There are no hidden charges. The song registration is
            ...
            <div class="mb-6 md:mb-8 lg:mb-12">
              ...
              <p class="text-neutral-500 dark:text-neutral-300">The system will check and respond the request.</p>
            </div>
            ...
            <div class="mb-6 md:mb-8 lg:mb-12">
              ...
              <p class="text-neutral-500 dark:text-neutral-300">The system checks and filter frauds and duplicates</p>
            </div>
